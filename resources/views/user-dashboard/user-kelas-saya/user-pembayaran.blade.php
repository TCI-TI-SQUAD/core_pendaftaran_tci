    ...
    <div class="container">
            ...
            <div class="col-12 m-0">
                ...
                <div class="row m-0 justify-content-center align-items-center">
                    ...
                    <div class="col-xl-8 col-lg-12 col-md-12 col-sm-12 col-xs-12 order-xl-2  order-lg-3">
                        ...
                        <li class="step">
                            <a href="#!">
                            <span class="circle bg-secondary">1</span><small>PEMBAYARAN</small>
                            </a>
                        </li>
        ...
        <div class="row d-flex justify-content-center p-2">
            <div class="col-xl-8 col-md-8 col-12 jumbotron p-0 z-depth-1 d-flex flex-column justify-content-center align-items-center">
                ...
                <div class="">
                    <p class="text-center">Bayar Sebelum <span class="text-secondary font-weight-bold">20 juli 2021</span></p>
                </div>
                <div class="">
                    <h4 class="text-secondary font-weight-bold">KELAS MANDARIN A</h4>
                </div>
                <div class="">
                    <h5 class="text-center"><span class="text-secondary font-weight-bold">IDR 120.000</span></h5>
                </div>
                <div class="">
                ...
                <div class="d-flex justify-content-center align-items-center mb-3 mt-3">
                    <button class="btn btn-sm btn-secondary">PANDUAN PEMBAYARAN</button>
                </div>
            </div>
        </div>
    </div>
