...
<script>
            ...
            "columns": [
                ...
                { "data": "updated_at","visible" :false },
                {
                    ...
                    render: function ( data, type, row, meta ) {
                        return '<a href="{{ route("admin.detail.pendaftarankelas") }}/'+data+'" class="btn btn-sm btn-primary"><i class="far fa-eye"></i></a><a href="{{ route("admin.edit.siswa") }}/'+data+'" class="btn text-white btn-sm btn-info"><i class="far fa-edit"></i></a><a class="btn text-white btn-sm btn-warning" onclick="archivePendaftaranKelas('+data+')"><i class="fas fa-file-archive"></i></a><a class="btn text-white btn-sm btn-danger" onclick="deletePendaftaranKelas('+data+')"><i class="far fa-trash-alt"></i></a> <form id="delete-pendaftaran-kelas-'+data+'" action="{{ route("admin.delete.pendaftarankelas") }}" method="POST" style=" display: none;"> @csrf @method("DELETE") <input name="id" value="'+data+'" type="hidden"></form>';
                    }
                }
            ],
        });
    ...
    function deletePendaftaranKelas(index){
            Swal.fire({
            title: 'Hapus Pendaftaran Kelas Ini ?',
            html: 
