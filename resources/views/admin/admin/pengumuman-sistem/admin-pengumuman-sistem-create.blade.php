...
<li class="breadcrumb-item active"><a href="{{ route('admin.pengumuman.sistem') }}">Pengumuman Sistem</a></li>
<li class="breadcrumb-item active">Create Pengumuman Sistem</li>
@endsection
...
<div class="row">
    <div class="col-12 jumbotron shadow p-2 mt-2">
        <div class="container-fluid">
            <form action="{{ route('admin.store.create.pengumuman.sistem') }}" method="POST" onsubmit="myButton.disabled = true; return true;">
                @csrf
                @method('POST')
                <div class="row">
                    <div class="col-12 text-center text-lg-left">
                        <h5>FORM CREATE PENGUMUMAN SISTEM</h5>
                    </div>
                    ...
                    <div class="col-12 text-center">
                        ...
                        <a href="{{ route('admin.pengumuman.sistem') }}" class="btn btn-md w-25 d-lg-inline-block d-none btn-danger">BATAL</a>
                        <a href="{{ route('admin.pengumuman.sistem') }}" class="btn btn-md w-100 mt-3 d-lg-none d-inline-block btn-danger">BATAL</a>
